...
module.exports = async (req, res) => {
  ...
  const system = [
    ...
    `- Cite the rule you rely on by wrapping the EXACT section heading from the rulebook in double curly braces so the app can turn it into a link — e.g. {{BLITZER AND RUSHER}}, {{POSSESSION AND CHANGE OF POSSESSION}}, {{OFFENSIVE LINE OF SCRIMMAGE PENALTIES}}. Only brace headings that appear verbatim in the rulebook below, and put the citation next to the claim it supports.`,
